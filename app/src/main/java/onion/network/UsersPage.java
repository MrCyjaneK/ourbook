...
public class UsersPage extends BasePage {
    ...
    public UsersPage(MainActivity activity) {
        super(activity);
    ...
    void load(final int i, String s) {
        ...
        new ItemTask(getContext(), address, "friend", s, count) {
            ...
            void fill(ItemResult itemResult, boolean finished) {
                ...
                findViewById(R.id.offline).setVisibility(0);// .setVisibility(!itemResult.ok() && !itemResult.loading() ? View.VISIBLE : View.GONE);
                findViewById(R.id.loading).setVisibility(0);// .setVisibility(itemResult.loading() ? View.VISIBLE : View.GONE);
